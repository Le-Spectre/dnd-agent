...
In addition to a number of subclasses from the[Player's Handbook](https://5e.tools/book.html#PHB), this section makes reference to the following subclasses from[Xanathar's Guide to Everything](https://5e.tools/book.html#XGE):
...
[](https://5e.tools/img/book/AI/027-03-04.png "THE CORPORATE BARBARIAN")
...
―[K'thriss Drow'b](https://5e.tools/bestiary.html#k'thriss%20drow'b_ai)
...
Truly, your intellect is as deep as a[Tenser's floating disk](https://5e.tools/spells.html#tenser's%20floating%20disk_phb).
...
―[Omin Dran](https://5e.tools/bestiary.html#omin%20dran_ai)
...
―[Walnut Dankgrass](https://5e.tools/bestiary.html#walnut%20dankgrass_ai)
...
A dark patch on your body is recognizable as the silhouette of[Omin Dran](https://5e.tools/bestiary.html#omin%20dran_ai)
...
[](https://5e.tools/img/book/AI/028-03-05.png "THE BUSINESS OF APPLIED KI")
...
―[Rosie Beestinger](https://5e.tools/bestiary.html#rosie%20beestinger_ai)
...
*Life is Endless Calamities, What Are You Going to Do About It*?
...
―[Donaar Blit'zen](https://5e.tools/bestiary.html#donaar%20blit'zen_ai)

[](https://5e.tools/img/book/AI/029-03-06.png "THE PALADIN AS FIXER")
...
―[M?rg?n](https://5e.tools/bestiary.html#m%c3%b4rg%c3%a6n_ai)
...
―[Viari](https://5e.tools/bestiary.html#viari_ai)
...
The Tumble Dumplings, an all-halfling guild whose cover identities are acrobats
...
[](https://5e.tools/img/book/AI/030-03-07.png "A WARLOCK'S OTHERWORLDY OFFICE")
...
―[Jim Darkmagic](https://5e.tools/bestiary.html#jim%20darkmagic_ai)

[](https://5e.tools/img/book/AI/031-03-08.png "THE MAGIC OF MONEY")
...
As a necromancer, you've always had an easy time making friends. Hah! That's hilarious because your friends are undead. But not everyone else in your franchise sees the lighter side of your magical craft. Clearly, the labor-to-paid-benefits ratio of undead interns can't be beat, but you need to be cognizant of the potential public-relations nightmare of franchise-branded zombies running amok. Still, if things get bad, there's nothing like a general marketing campaign reminding local folk that necromancy means[raise dead](https://5e.tools/spells.html#raise%20dead_phb). Even if you can't cast it.
