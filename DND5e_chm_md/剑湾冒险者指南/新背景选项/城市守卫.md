...
**技能熟练项：**运动、洞悉
**语言：**两门自选语言
**装备：**一件你所在组织的标示你军衔的制服，一个用来召唤帮手的号角，一副手铐，以及一个装有10gp的小包
...
**比警戒或是巡逻人员更稀有的是组织的调查员，专门负责调查犯罪后的真相。尽管这些人很少出现在乡村地带，几乎每一个像样规模的案子都会有一个或者两个有调查犯罪现场和追踪罪犯技能的调查员。如果你曾经是一名调查员，则你可以将背景的运动技能熟练项替换为调查技能熟练项。
