...
**不死本质****Undead Nature**。一名幻灵不需要空气、饮食，以及睡眠。

**迅步幻灵****Flitterstep Eidolon**
中型不死 任意
AC 14
HP 44(8d8+8）
速度40尺
...
抵抗驱散Turn Resistance。幻灵抵抗驱散不死生物效应所做的豁免检定具有优势。
动作Action
多重攻击Multiattack.
幻灵进行两次近战攻击。在它的一次攻击之前或之后，它可以使用Flitterstep(如果它可用)。
近战武器攻击：+6，触及5尺，单一目标。
命中：6（1d4+4）穿刺伤害，外加3（1d6）精神伤害
迅捷步Flitterstep (充能5C6)
幻灵魔法般地传送到30尺内它能看到的一个未被占据的空间。如果它在传送后立即进行攻击，它在攻击骰上具有优势。
...
语言：生前所知道的语言
挑战：5(1,800 XP)
模糊轮廓 blurred form除非幻灵陷入失能，否则对它的攻击骰具有劣势。
虚体移动Incorporeal Movement。幻灵能像穿过困难地形那样穿过其他生物或物件。它在回合结束时若处于物件内则受到5（1d10）的力场伤害。
抵抗驱散Turn Resistance。幻灵抵抗驱散不死生物效应所做的豁免检定具有优势。
动作Action
多重攻击Multiattack.
...
鬼刃Ghostblade.
近战武器攻击：+6，触及5尺，单一目标。
伤害：7（1d8+3）挥砍伤害，外加11（2d10）力场伤害。
