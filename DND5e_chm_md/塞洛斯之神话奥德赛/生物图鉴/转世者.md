转世者Returned
转世者自冥界逃离，再一次生活于生者之间，但他们的第二次生命并非他们所期望那般――因为他们已不再记得自己曾经期望之物。作为追随裴纳克之路（见第四章）的结果，转世者丧失了他们的人格，任其化作了称为幻灵的独立生物。逃离冥界的经历也让他们失去了面孔，脸上徒余没有表情的面具，眼孔和嘴巴空洞呆滞。他们使用这些独特的黄金面具来盖住空白的面庞。
转世者作为空洞而不死的生物重返世界。他们不再具有形成长期记忆的能力，也通常无法建立有意义的关系或开始新的生活。大部分转世者体验着转瞬即逝的情感，遵循着空洞的程序，他们的存在变得如同皮影戏一般不再有重量和实感。
转世者面具Returned Masks.在战斗中击败了转世者敌人的冒险者们可能会对自己的丰厚战利品感到惊讶。一张转世者面具价值约100gp，但出售一张转世者的面具并非简单地将其换成金钱。大部分塞洛斯人知道转世者的故事，并不愿意和这些被诅咒的遗物以及试图售出他们的人扯上关系。很少能找到一个百无忌讳的商人来卖出这些东西，因为它们实际上是另一个智慧生物的脸。说服一个商人买下一张转世者的面具或者处理这种交易带来的后果，这本身就可能是一场冒险。
转世者本质Returned Nature.转世者是不死生物。他们需要水和空气，但无需进食和睡眠，他们能根据自己新近的经历思考、说话甚至感受到情绪，但考虑到他们的状况，这些情绪往往会被抑制住。
...
转世漂浪客Returned Drifter
许多转世者都是可怜的灵魂，他们设法逃离了冥界，却失去了驱使他们逃离死亡的激情。由于缺乏目标和生者的避讳，转世者通常会寻找一个能让自己享受安宁之地，如孤独的坟茔，或安福陵与俄渡诺陵这样的陵寝。在那里，他们冷淡地模仿着生前的生活，陷于分心和无聊之中。即便如此，即使是最为懒散的转世者在受到威胁时也会保护自己，也更可能会被迫为他们更有意志的同胞服务。
...
速度：30尺
――――――――――――――――
力量14(+2) 敏捷15(+2) 体质12(+1) 智力10(+0) 感知12(+1) 魅力11(+0)
――――――――――――――――
伤害抗性：暗蚀
伤害免疫：毒素
状态免疫：中毒
...
挑战等级：1/4(50XP)
――――――――――――――――
抵抗驱散Turn Resistance.转世者在对抗驱散不死生物效应时豁免检定具有优势。
莫测面容Unreadable Face.转世者免疫一切可以感知其情绪或阅读其思想的效应。揣摩转世者意图的感知（洞悉）检定具有劣势。
动作Actions
――――――――――――――――
弯刀Scimitar.近战武器攻击：命中+4，触及5尺，单一目标。
伤害：5（1d6+2）的挥砍伤害，外加3（1d6）毒素伤害。
投石索Sling.远程武器攻击：命中+5，射程30/120尺，单一目标。
伤害：4（1d4+2）的钝击伤害。
转世泄怨者Returned Palamnite
...
速度：30尺
――――――――――――――――
力量10(+0) 敏捷17(+3) 体质14(+2) 智力13(+1) 感知12(+1) 魅力15(+2)
――――――――――――――――
技能：特技+5，运动+2，隐匿+5
伤害抗性：暗蚀
伤害免疫：毒素
...
挑战等级：4(1100XP)
――――――――――――――――
怒意爆发Fleeting Anger.如果另一个生物对其造成了伤害，直到下个其回合结束，转世者对该生物的攻击检定具有优势。
抵抗驱散Turn Resistance.转世者在对抗驱散不死生物效应时豁免检定具有优势。
莫测面容Unreadable Face.转世者免疫一切可以感知其情绪或阅读其思想的效应。揣摩转世者意图的感知（洞悉）检定具有劣势。
动作Actions
――――――――――――――――
多重攻击Multiattack.转世者进行两次短剑攻击。
短剑Shortsword.近战武器攻击：命中+5，触及5尺，单一目标。
伤害：6（1d6+3）的穿刺伤害，外加10（3d6）毒素伤害。

变体：转世秽言使Variant: Returned Kakomantis
虽然死者鲜有能回忆起生前的记忆，但一些转世者生前怀着对魔法的痴迷，在死亡和转世之后仍然余存。这些被称为秽言使的转世者能够使用他们的魔法来操纵弥散在冥界中的能量。转世秽言使使用泄怨者的数据，并用以下动作代替多重攻击：
幽冥之矢Underworld Bolt.远程法术攻击：命中+4，范围120尺，单一生物。
伤害：13（2d8+2）暗蚀伤害，目标直到下个转世秽言使的回合开始无法恢复生命值。如果目标失去过生命值，则其改为受到17（2d12+2）暗蚀伤害。

Although the dead typically recall little of their lives, some have an obsession with magic that survives both death and rebirth as a Returned. These Returned, called kakomanteis, use their magical prowess to control the energy that suffuses the Underworld. A Returned kakomantis has the statistics of a Returned palamnite and uses the following action option in place of Multiattack:
Underworld Bolt. Ranged Spell Attack: +4 to hit, range 120 ft., one creature. Hit: 13 (2d8 + 2) necrotic damage, and the target can't regain hit points until the start of the Returned's next turn. If the target is missing any of its hit points, it instead takes 17 (2dl 2 + 2) necrotic damage.

转世哨卫Returned Sentry
大部分新近转世或漫无目的的转世者很容易被操纵去为他们更有力量的同胞服务。在目标的驱使下，这些转世者能够以中等效率执行简单明了的命令。他们的优点在于不知疲倦，这让他们成为出色的守卫。在死者的城邦中，有许多转世者担任着哨卫的工作，而他们也能作为信使或者劳工。一旦受到威胁，成队的转世者会团结一致，共同完成战胜敌人并回归原本工作的目标。
...
速度：30尺
――――――――――――――――
力量16(+3) 敏捷15(+2) 体质12(+1) 智力10(+0) 感知12(+1) 魅力11(+0)
――――――――――――――――
伤害抗性：暗蚀
伤害免疫：毒素
状态免疫：中毒
...
挑战等级：1(200XP)
――――――――――――――――
集群战术Pack Tactics. 至少有一个未处于失能的盟友在目标生物5尺内时，转世者对该生物发动的攻击检定有优势。
抵抗驱散Turn Resistance.转世者在对抗驱散不死生物效应时豁免检定具有优势。
莫测面容Unreadable Face.转世者免疫一切可以感知其情绪或阅读其思想的效应。揣摩转世者意图的感知（洞悉）检定具有劣势。
动作Actions
――――――――――――――――
矛Spear.近战或远程武器攻击：命中+5，触及5尺或射程20/60尺，单一目标。命中：6（1d6+3）的穿刺伤害，或使用双手发动近战攻击时7（1d8+3）的穿刺伤害，外加7（2d6）的毒素伤害。
投石索Sling.远程武器攻击：命中+5，触及5尺，单一目标。
伤害：5（1d4+3）的钝击伤害。
