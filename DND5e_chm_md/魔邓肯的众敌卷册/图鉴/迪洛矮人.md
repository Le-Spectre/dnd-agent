...
**魔法抗性Magic Resistance：**迪洛矮人抵抗法术及其它魔法效应时进行的豁免检定具有优势。
**日照敏感Sunlight Sensitivity：**处于阳光下的迪洛矮人在进行攻击检定，以及进行依赖视觉的感知（察觉）检定上具有劣势。
**动作**
**带钩短矛Hooked Spear：**近战武器攻击:命中+2，触及 5 尺，单一目标。伤害:3（1d6）的穿刺伤害。如果目标是中型及以下大小的生物， 迪洛矮人可以选择使目标倒地并取消所造成的伤害。
**连发轻弩Light Crossbow：**远程武器攻击:命中+4， 射程 80/320尺，单一目标。伤害:6(1d8+2)的穿刺伤害。
...
**魔法抗性Magic Resistance：**迪洛矮人抵抗法术及其它魔法效应时进行的豁免检定具有优势。
**施法Spellcasting：**迪洛矮人作为 5 级施法者。他的施法属性为魅力（法术豁免 DC 12，法术攻击命中+4）迪洛矮人学习了 以下术士法术:
戏法（随意）：酸液飞溅 Acid Splash，法师之手Mage Hand，传讯术Message，魔法伎俩Prestidigitation，冷冻射线Ray of Frost
1 环（4 法术位）：燃烧之手Burning Hands，繁彩球Chromatic Orb，睡眠术Sleep
2环（3 法术位）：隐形术Invisibility，蛛行术Spider Climb
3环（2 法术位）：闪电束Lightning Bolt
**日照敏感Sunlight Sensitivity：**处于阳光下的迪洛矮人在进行攻击检定，以及进行依赖视觉的感知（察觉）检定上具有劣势
**动作**
**长棍Quarterstaff：**近战武器攻击，命中+1，触及5尺，单一目标。伤害2（1d6-1）的钝击伤害。
