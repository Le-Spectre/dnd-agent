...
Steeders. Giant hunting spiders, steeders prowl the depths of the Underdark. Most steeders are encountered in the company of duergar.
...
**蛛行Spider Climb。**骑蛛可以在困难表面上攀爬。包括倒挂在天花板上移动，且无需进行任何属性检定。
**飞跃Extraordinary Leap。**骑蛛进行跳远时距离增加三倍：它每花费1尺移动距离，则增至为3尺跳远距离。
**动作**
**啃咬Bite。**近战武器攻击：命中+5，触及5 尺，单一目标。命中：7（1d8+3）的穿刺伤害，及额外9（2d8）的毒素伤害。
**粘性长腿Sticky Leg。**近战武器攻击：命中+5，触及5 尺，单一中型或更小体型生物。命中：目标被骑蛛的长腿擒抱住直至挣脱（挣脱DC 12），骑蛛一次只能擒抱一个生物。
...
**飞跃Extraordinary Leap。**骑蛛进行跳远时距离增加三倍：它每花费1尺移动距离，则增至为3尺跳远距离。
**动作**
**啃咬Bite。**近战武器攻击：命中+4，触及5 尺，单一目标。命中：6（1d8+2）的穿刺伤害，及额外4（1d8）的毒素伤害。
**粘性长腿Sticky Leg。**近战武器攻击：命中+4，触及5 尺，单一小型或更小体型的生物。命中：目标被骑蛛的长腿擒抱住直至挣脱（挣脱DC 12）。
