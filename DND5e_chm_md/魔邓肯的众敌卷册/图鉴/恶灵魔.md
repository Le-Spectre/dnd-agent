...
伤害免疫：毒素
状态免疫：魅惑，力竭，恐慌，擒抱，石化，麻痹，中毒 ，倒地，束缚
感官：黑暗视觉 120尺，被动察觉 14
语言：深渊语，通用语，心灵感应120尺
挑战等级 4（1100XP）

**灵体移动。** 恶灵魔可以穿过任意生物或物体，视作困难地形。如果它在回合结束时停留在物体内部，则受到5（1d10）点力场伤害。
**天生施法。**恶灵魔天生的施法能力基于魅力(法术豁免DC12)。它可以天生使用以下咒语，不需要任何材料成分:
随意：任意门
每项3次/日：恐惧术，魅影之力
**魔法抗性 Magic Resistance。**恶灵魔对抗法术和魔法效应时进行的豁免检定具有优势。
**亵渎尸体。**恶灵魔在占据一具尸体时可以使用附赠动作，让尸体呈现一些灵异现象，比如吐血、头部扭转来、或者让四足动物像两足动物一样移动。任何看到这种行为的野兽或类人生物必须在DC12的感知豁免中成功，否则就会对怪物恐惧1分钟。陷入恐惧的生物在每个自己回合结束时重复豁免，成功则结束影响。豁免成功的生物在24小时内对该效果免疫。
**动作
卷须Tendril。**近战武器攻击：+6命中，触及5尺，一个目标。命中：13 (2d8+4)黯蚀伤害。如果目标是一个生物，它的生命值最大值也下降3 (1d6)。这一过程持续到目标完成一次短或长休息。如果此效果将目标的最大生命值降低到0，则目标死亡。
占据尸体(充能6)。恶灵魔消失并进入一个5尺内、它能看到的完整尸体。尸体必须是大型或更小的野兽或类人生物。恶灵魔现在实际上是被附身的生物。它的类型变成不死生物，虽然它现在看起来个活着的生物，并且它获得一些临时生命值等于尸体生命值的最大值。
