...
**心灵镜面 Psychic Mirror。** 如果该巨怪受到心灵伤害，那么作为替代，每一个离该巨怪10英尺以内的生物都会受到等值的心灵伤害；该巨怪不承受该次伤害。此外，该巨怪的思想和位置无法被魔法识别。
**动作 ACTIONS**
**多重攻击（Multiattack）。**该巨怪进行两次猛击。若两次攻击命中同一目标，则目标额外受到9（2d8）心灵伤害，且须成功于DC17的体质豁免，否则被震慑直至目标的下回合结束。
猛击 slam。近战武器攻击：命中+9，触及10尺，单一目标。命中：14（2d8+5）钝击伤害
**武装收割 Reaping Arms（充能5-6）。** 该巨怪对其周围10尺范围内的每个生物进行一次单独的猛击（slam），每一个被击中的生物都必须通过DC17的敏捷豁免，否则被击倒在地。
